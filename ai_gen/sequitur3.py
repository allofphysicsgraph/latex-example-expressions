...
class Symbol:
    ...
    def join(self, left, right):
        if left.n is not None:
            ...
            if (
                right.p is not None
                and right.n is not None
                and right.value == right.p.value
                and right.value == right.n.value
            ):
                digrams[str(right.value) + str(right.n.value)] = right
            if (
                left.p is not None
                and left.n is not None
                and left.value == left.p.value
                and left.value == left.n.value
            ):
...
# def test():
#    test_string = "abracadabraabracadabra"
#    print(test_string)
#    out = run_sequitur(test_string)
#    print(out)
# test()
